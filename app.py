...
if uploaded_file is not None:
    ...
    with col1:
        ...
        st.image(spatial_img_resized, caption="Uploaded Image", use_column_width=True)
    with col2:
        st.subheader("2. Frequency Spectrum")
        st.image(original_fft_img, caption="FFT Extracted", use_column_width=True)
    with col3:
        st.subheader("3. Explainability (Grad-CAM)")
        st.image(superimposed_fft, caption="Network Activation Zones", use_column_width=True)